...
for i in range(35):
    ...
    config.peak_intensity = 1e14 + (i*0.5e14)/35
    ...
    np.savetxt('/home/alex/Desktop/Python/SNAIL/AnneData/cycles{}Inten{}'.format(config.calculation_cycles,int(config.peak_intensity/1e14),driving_field[0])
    ...
    plt.tight_layout()
    plt.savefig('/home/alex/Desktop/Python/SNAIL/AnneData/cycles{}Inten{}.png'.format(config.calculation_cycles,int(config.peak_intensity/1e14)),)
    plt.show()
